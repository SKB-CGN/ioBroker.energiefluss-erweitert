# ⚡ Energiefluss Erweitert – Feature-Übersicht

## 🌐 Allgemein
- [x] Konfiguration via Web-Oberfläche statt über ioBroker
- [x] Die Arbeitsfläche lässt sich frei in Breite und Höhe gestalten
- [x] Grundwerte können für jedes Element angegeben werden, damit sie nicht erneut für jedes Element geändert werden müssen
...
- [x] Verschiedene Grundeinstellungen können festgelegt werden, um Farben, Größen, Formen vorzubelegen

---

## 📑 Views / Tabs
- [x] Erstellung von Views/Tabs möglich
- [x] Tabs können Icons und Text enthalten
- [x] Views/Tabs lassen sich flexibel ein- und ausblenden
...
- [x] CSS-Klassen können den verschiedenen Stati des Datenpunktes zugewiesen werden: Aktiv positiv, Aktiv negativ, Inaktiv positiv und Inaktiv negativ
...
- [x] Bi-direktionale Linien möglich (Änderung der Animationsrichtung bei Wechsel von positiv zu negativ)
