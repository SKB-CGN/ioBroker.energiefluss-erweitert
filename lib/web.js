...
class ProxyEnergieflussErweitert {
    constructor(server, webSettings, adapter, instanceSettings, app) {
        ...
        this.app.post("/" + this.config.route + "upload", (req, res) => {
            if (req) {
                adapter.log.warn(req.body);
            } else {
                adapter.log.warn('Nothing provided!');
            }
        ...
        this.app.use("/" + this.config.route, (req, res) => {
            ...
            let message;
            adapter.log.warn(this.config.route);
            ...
            switch (query.serve) {
                ...
                case 'upload':
                    ...
                    adapter.log.warn('Uploading called!');
                    adapter.log.warn(JSON.stringify(req));
                    break;
